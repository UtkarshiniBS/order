        ...
        class OrderDetailsScraper extends Scraper {
            constructor() {
                ...
                this.selectors = {
                    ...
                    paymentMethodSelector: '.bill-order-payment-card span, .bill-order-payment-card img'
                };
            }
            ...
            async scrape() {
                ...
                paymentObject = paymentObject.filter((tagValue,tagIndex) => {
                    if(!(paymentObject[tagIndex-1] && paymentObject[tagIndex-1].tagName === 'IMG') && tagValue) {
                        return true;
                    }
                });
                ...
                orderCardAll.forEach(card => {
                    ...
                    let cardItems = Array.from(card.querySelectorAll(this.selectors.itemCardSelector));
            ...
            getDOMelement() {
                ...
                let paymentObject = Array.from(document.querySelectorAll(this.selectors.paymentMethodSelector));
