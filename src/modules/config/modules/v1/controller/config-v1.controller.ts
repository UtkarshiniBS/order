...
@Controller('v1/scraper_config')
@ApiTags('Scraper Configuration')
export class ConfigV1Controller extends ConfigController {
  ...
  @ApiOperation({
    ...
    summary: 'API to show $$ flag in the APP using `manualScrapeIncentiveDays`  and `` configuration'
  })
